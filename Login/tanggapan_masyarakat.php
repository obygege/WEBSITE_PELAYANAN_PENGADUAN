        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2">
             ...
             <div class="slider_text ">
                                <h3 style="color:white"> Web<br>
                                    Pengaduan Masyarakat</h3>
                                <p style="color:white">Selamat datang di web Pengaduan Masyarakat Dinas Permukiman Penduduk Kabupaten Muba<br>
                                                        Silahkan sampaikan Keluh Kesah anda melalui laman web ini</p>
