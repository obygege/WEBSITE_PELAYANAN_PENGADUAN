                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 ">
                         <li><a href="https://maps.app.goo.gl/QjRnXL2dHgv6uXhDA" style="color:white"><i class="fa fa-podcast"> Kantor Dinas Permukiman Penduduk Cek Lokasi disini</i></a></li>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> perkim@gmail.com</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i>0800-0000-0000</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text">
                                ...
                                <p>Selamat datang di web Pengaduan Masyarakat Dinas Permukiman Penduduk Kabupaten Muba<br>
